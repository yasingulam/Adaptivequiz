...
public class QuestionLoaderComputing : MonoBehaviour
{
    ...
    {
        int hardwarequestioncount = calculatecomputingQs.hardwareQuestionCount;
        int softwarequestioncount = calculatecomputingQs.softwareQuestionCount;
        int programmingquestioncount = calculatecomputingQs.programmingQuestionCount;
        Debug.Log("values are : " + hardwarequestioncount + " " + softwarequestioncount + " " + programmingquestioncount);
        ...
        questionData.Add("hardware", new List<string[]>());
        questionData.Add("software", new List<string[]>());
        questionData.Add("programming", new List<string[]>());

        // Get the question data from the database using a PHP script
        string url = "http://localhost/unity/QuestionRetreival/computingQretreival.php?" +
                     "hardwarequestioncount=" + hardwarequestioncount +
                     "&softwarequestioncount=" + softwarequestioncount +
                     "&programmingquestioncount=" + programmingquestioncount;
        ...
        foreach (KeyValuePair<string, List<string[]>> topic in questionData)
        {
            ...
            {
                case "hardware":
                    count = hardwarequestioncount;
                    break;
                case "software":
                    count = softwarequestioncount;
                    break;
                case "programming":
                    count = programmingquestioncount;
                    break;
            }
        ...
        Debug.Log("computing questions created");
