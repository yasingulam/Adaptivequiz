...
public class QuestionLoaderMaths : MonoBehaviour
{
    ...
    {
        int algebraquestioncount = calculatemathsQs.algebraQuestionCount;
        int arithmeticquestioncount = calculatemathsQs.arithmeticQuestionCount;
        int fdpquestioncount = calculatemathsQs.fdpQuestionCount;
        Debug.Log("values are : " + algebraquestioncount + " " + arithmeticquestioncount + " " + fdpquestioncount);
        ...
        questionData.Add("algebra", new List<string[]>());
        questionData.Add("arithmetic", new List<string[]>());
        questionData.Add("fdp", new List<string[]>());

        // Get the question data from the database using a PHP script
        string url = "http://localhost/unity/QuestionRetreival/mathQretreival.php?" +
                     "algebraquestioncount=" + algebraquestioncount +
                     "&arithmeticquestioncount=" + arithmeticquestioncount +
                     "&fdpquestioncount=" + fdpquestioncount;
        ...
        foreach (KeyValuePair<string, List<string[]>> topic in questionData)
        {
            ...
            {
                case "algebra":
                    count = algebraquestioncount;
                    break;
                case "arithmetic":
                    count = arithmeticquestioncount;
                    break;
                case "fdp":
                    count = fdpquestioncount;
                    break;
            }
        ...
        Debug.Log("maths created questions");
